...
def plt_roc():
    ...
    #plt.show()
    plt.savefig("./img/DT/ROC_dt.png", dpi=300)
...
d_tree = DecisionTreeClassifier(max_depth= 28, random_state= 4)
...
fig.savefig("./img/DT/CM_DT.png", dpi=300)
#print(c_matrix)
...
print('')
print("Binary Accuracy for Decision Tree Classifier: ", bin_acc)
print('')

#Save the model
joblib.dump(d_tree, './saved_model/dt_model.pkl')
print('')
