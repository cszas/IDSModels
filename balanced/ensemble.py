...
# Dataframe
df_p = pd.DataFrame(columns=('KNN', 'DT', 'RF', 'XGB', 'MLP', 'LSTM'))
...
def train_and_test():
    ...
    x_6_train = X_train[['sbytes', 'dbytes', 'sload', 'smean', 'dmean', 'ct_srv_dst']]
    x_6_test = X_test[['sbytes', 'dbytes', 'sload', 'smean', 'dmean', 'ct_srv_dst']]
