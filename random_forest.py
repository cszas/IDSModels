...
def cross_v():
    ...
    tuned_parameters = [{'criterion': ('gini', 'entropy'),
                        ...
                        'min_samples_leaf': np.arange(3, 40),
                        'min_samples_split': np.arange(3, 40),
    ...
    for score in scores:
        ...
        gs = GridSearchCV(RandomForestClassifier(), tuned_parameters, cv=10, scoring='%s_weighted' % score)
...
print('')
print("Confusion Matrix for Random Forest Classifier saved.")
...
#print('')
#print('Clasification Report for Random Forest Classifier:')
...
print('')
print('ROC Curves for Random Forest Classifier saved.')
plt_roc()
