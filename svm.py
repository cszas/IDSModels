...
def cross_v():
    ...
    for score in scores:
        ...
        gs = GridSearchCV(SVC(kernel='rbf'), tuned_parameters, cv=10, scoring='%s_weighted' % score)
...
svm = SVC(kernel='rbf', gamma='scale', C=50,max_iter=50000, probability=True)
